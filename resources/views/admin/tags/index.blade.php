...
@section('content')
    ...
    <a href=" {{ route('admin.tags.create') }}" class="btn btn-info">Agregar nuevo tag</a>
    <!-- Buscador de tags -->
            ...
            @foreach($tags as $tag)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.tags.destroy', $tag->id) }}" onclick="return confirm('¿Seguro que deseas eliminar usuario?')"
