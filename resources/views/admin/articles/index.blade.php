...
@section('content')
    ...
    <a href=" {{ route('admin.articles.create') }}" class="btn btn-info">Agregar nuevo articulo</a>
        ...
        @foreach($articles as $article)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.articles.destroy', $article->id) }}" onclick="return confirm('¿Seguro que deseas eliminar usuario?')"
